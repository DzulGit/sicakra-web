...
const TagihanSayaListPage = () => import('@/modules/tagihan/pages/pelanggan/TagihanSayaListPage.vue')
const TagihanSayaDetailPage = () => import('@/modules/tagihan/pages/pelanggan/TagihanSayaDetailPage.vue')
