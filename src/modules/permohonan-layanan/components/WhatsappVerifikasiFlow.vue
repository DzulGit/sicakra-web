        ...
        <CardContent class="space-y-4">
          <div class="grid grid-cols-2 gap-4 rounded-lg bg-muted p-4 text-sm">
            ...
            <div>
              ...
              <p class="font-medium">
                {{ permohonan.tipe_paket === 'reguler' ? permohonan.paket_internet?.nama_paket : permohonan.nama_paket_custom }}
              </p>
            </div>
            <div>
          ...
          <div class="flex gap-2">
            ...
            <Button
              @click="
                () => {
                  navigator.clipboard.writeText(waMessage.text)
