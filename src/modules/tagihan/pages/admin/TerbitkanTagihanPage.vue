...
import { useDraftTagihanList, useTerbitkanTagihan } from '../../composables/useKeuanganTagihan'
import type { DraftTagihan } from '../../api/keuanganTagihan.api'
...
const { data: hasil, isLoading } = useDraftTagihanList()
const terbitkanMut = useTerbitkanTagihan()
