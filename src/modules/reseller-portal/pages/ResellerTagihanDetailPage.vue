...
import { useResellerTagihanDetail, useResellerBayarTunaiTagihan, useResellerPerbaruiLinkTagihan } from '../composables/useResellerTagihan'
...
const { data: tagihan, isLoading, refetch } = useResellerTagihanDetail(id)
const { mutate: bayarTunai, isPending: isBayarTunaiPending } = useResellerBayarTunaiTagihan()
const { mutate: perbaruiLink, isPending: isPerbaruiLinkPending } = useResellerPerbaruiLinkTagihan()
